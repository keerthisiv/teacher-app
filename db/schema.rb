...
ActiveRecord::Schema.define(version: 20200208170741) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "log_events", id: :bigserial, force: :cascade do |t|
    t.bigint   "teacher_id"
    ...
    t.index ["logged_at"], name: "index_log_events_on_logged_at", using: :btree
